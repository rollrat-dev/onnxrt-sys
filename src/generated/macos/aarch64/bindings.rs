...
fn bindgen_test_layout___darwin_arm_amx_state_v1() {
    ...
    assert_eq!(
        ...
        0usize,
        concat!("Offset of field: ", stringify!(__darwin_arm_amx_state_v1), "::", stringify!(__x))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<__darwin_arm_amx_state_v1>())).__y as *const _ as usize },
        512usize,
        concat!("Offset of field: ", stringify!(__darwin_arm_amx_state_v1), "::", stringify!(__y))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<__darwin_arm_amx_state_v1>())).__z as *const _ as usize },
        1024usize,
        concat!("Offset of field: ", stringify!(__darwin_arm_amx_state_v1), "::", stringify!(__z))
    );
    assert_eq!(
        unsafe {
